	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 SK_E2 /home/torbjone/bedlewo/project/hay_model/mod/x86_64/SK_E2.mod\n");
...
static int  rates ( _p, _ppvar, _thread, _nt, _lca ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lca ;
 {
   if ( _lca < 1e-7 ) {
     _lca = _lca + 1e-07 ;
